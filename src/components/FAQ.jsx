...
import carousel from '../assets/img/carousel-2.png'
import {getFAQ} from '../api/apiGet'
            ...
            <div className="container py-5">
                <div className="row g-5 align-items-center">
                        ...
                        <div className="h-100">
                            <div className="mb-5">
                                ...
                                <Link 
                                    ...
                                    style={{ color: '#015fc8',}}
                                    onMouseOver={(e) => (e.currentTarget.style.color = '#232b3c')}
                                    onMouseOut={(e) => (e.currentTarget.style.color = '#015fc8')}
                                >
                                    More FAQ <i className="fa fa-arrow-right"></i>
                                </Link>
                                <h1 className="display-4 mb-0">คำถามที่พบบ่อย</h1>
                            </div>
                    ...
                    <div className="col-xl-6 wow fadeInRight" data-wow-delay="0.4s">
                        <img src={carousel} className="img-fluid w-100" alt="faq" />
                    </div>
                </div>
            </div>
        </div>
